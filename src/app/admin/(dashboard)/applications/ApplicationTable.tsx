        ...
        <tbody>
          {applications.map((application) => (
            <tr key={application.id} className="border-b border-[#e6edf0] bg-white transition hover:bg-[#f8fafb]">
              ...
              <td className="whitespace-nowrap px-5 py-4 text-xs text-[#010608]/55">{(application.submittedAt ?? application.createdAt).toLocaleString("en-IN", { dateStyle: "medium", timeStyle: "short" })}</td>
