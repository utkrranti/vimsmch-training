...
export const metadata: Metadata = {
  ...
  description:
    "Browse UGC approved, NSQF-aligned vocational programmes in healthcare and allied sciences at VIMSMCH.",
};
        ...
        <div className="bg-[#04415f]/5 border-b border-[#04415f]/15 py-3 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto flex flex-wrap gap-x-8 gap-y-1 text-xs text-[#010608]/60">
            <span>
              ...
              All fees shown are total course fees. No additional charges without prior written notice — as per UGC norms.
            </span>
            <span>
              <span className="text-[#04415f] font-semibold">Certificates: </span>
              Issued by VIMSMCH and/or the affiliating university upon successful completion.
            </span>
          </div>
        </div>
