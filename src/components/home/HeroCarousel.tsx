...
export default function HeroCarousel({ instituteNotice }: HeroCarouselProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-full w-full items-center justify-center px-4 py-8 sm:px-8 sm:py-12">
        {/* Frosted glass panel — only this area sits over a blurred backdrop */}
        <div className="w-full max-w-6xl rounded-[2rem] border border-white/50 bg-white/45 px-6 py-8 shadow-[0_20px_60px_rgba(1,30,44,0.25)] backdrop-blur-xl sm:px-14 sm:py-12">
